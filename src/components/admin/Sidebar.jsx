...
export default function Sidebar({ activePage, handleActivePage, user }) {
  return (
    <div className="flex flex-col ps-2 min-h-screen text-start gap-5 pt-10 bg-neutral-800 text-yellow-500 text-md font-bold sticky top-0">
      <button
        className={`flex items-center gap-1 hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "Overview" ? "text-yellow-600 bg-slate-200" : ""
          }`}
        onClick={() => handleActivePage("Overview")}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-front" viewBox="0 0 16 16">
      ...
      <button
        className={`flex items-center gap-1 text-start hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "person of concern"
      ...
      <button
        className={`flex items-center gap-1 hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "officer" ? "text-yellow-600 bg-slate-200" : ""
          }`}
      ...
      <button
        className={`flex items-center gap-1 text-start hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "crimes" ? "text-yellow-600 bg-slate-200" : ""
          }`}
        onClick={() => handleActivePage("crimes")}
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-list-columns-reverse" viewBox="0 0 16 16">
      ...
      <button
        className={`flex items-center gap-2 text-start hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "crime index" ? "text-yellow-600 bg-slate-200" : ""
          }`}
      ...
      <button
        className={`flex items-center gap-1 hover:text-yellow-600 duration-200 p-2 rounded-t-sm ${activePage === "upload" ? "text-yellow-600 bg-slate-200" : ""
          }`}
