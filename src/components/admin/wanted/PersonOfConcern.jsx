    ...
    <div className="w-full h-full p-2 sm:p-5 shadow-lg rounded-sm bg-white">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 w-3/6">
          <div>
            <p className="cursor-pointer"><input type="radio" name="type" className="cursor-pointer" onChange={handleFilterChange} checked={filter === 'WANTED PERSON'} value={"WANTED PERSON"} /> WANTED PERSON</p>
            <p className="cursor-pointer"><input type="radio" name="type" className="cursor-pointer" onChange={handleFilterChange} checked={filter === 'MISSING PERSON'} value={"MISSING PERSON"} /> MISSING PERSON</p>
          </div>
          <input
            type="search"
      ...
      <div className="flex flex-col py-2 gap-4">
        ...
        <PersonTable personList={personList} handleModal={handleModal} setSelected={setSelected} />
      </div>
    </div>
  );
}
